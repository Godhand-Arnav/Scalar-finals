...
[![Space](https://img.shields.io/badge/🤗-Live%20Demo-blue)](https://huggingface.co/spaces/YOUR_USERNAME/forge-ma)
[![Colab](https://colab.research.google.com/assets/colab-badge.svg)](training/forge_grpo_colab.ipynb)

> **[▶ Live Environment](https://huggingface.co/spaces/YOUR_USERNAME/forge-ma)** |
> **[📓 Training Notebook](training/forge_grpo_colab.ipynb)** |
> **[📝 Blog Post](https://huggingface.co/blog/YOUR_USERNAME/forge-ma)**
...
```bash
pip install git+https://huggingface.co/spaces/YOUR_USERNAME/forge-ma
```
